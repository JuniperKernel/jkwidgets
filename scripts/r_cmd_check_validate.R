...
# This is run as part of the CI suite of tests for jkwidgets.
#
# This step performs the following steps:
#   1. Read in the file jkwidgets.Rcheck/00check.log
...
(function() {
  path <- file.path('.', 'jkwidgets.Rcheck', '00check.log')
  if( !file.exists(path) )
  ...
  status <- chkResults$jkwidgets$status
